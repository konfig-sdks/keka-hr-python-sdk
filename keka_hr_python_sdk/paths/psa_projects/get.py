...
from keka_hr_python_sdk.model.api_project_paged_response import APIProjectPagedResponse as APIProjectPagedResponseSchema

from keka_hr_python_sdk.type.api_project_paged_response import APIProjectPagedResponse

from ...api_client import Dictionary
from keka_hr_python_sdk.pydantic.api_project_paged_response import APIProjectPagedResponse as APIProjectPagedResponsePydantic

from . import path

# Query params
ClientIdsSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'clientIds': typing.Union[ClientIdsSchema, str, ],
...
request_query_client_ids = api_client.QueryParameter(
    name="clientIds",
    style=api_client.ParameterStyle.FORM,
    schema=ClientIdsSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = APIProjectPagedResponseSchema
SchemaFor200ResponseBodyTextJson = APIProjectPagedResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: APIProjectPagedResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_all_mapped_args(
        ...
        if client_ids is not None:
            _query_params["clientIds"] = client_ids
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> APIProjectPagedResponsePydantic:
        ...
        if validate:
            return APIProjectPagedResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(APIProjectPagedResponsePydantic, raw_response.body)
