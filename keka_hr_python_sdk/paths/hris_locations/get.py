...
from keka_hr_python_sdk.model.location_paged_response import LocationPagedResponse as LocationPagedResponseSchema

from keka_hr_python_sdk.type.location_paged_response import LocationPagedResponse

from ...api_client import Dictionary
from keka_hr_python_sdk.pydantic.location_paged_response import LocationPagedResponse as LocationPagedResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = LocationPagedResponseSchema
SchemaFor200ResponseBodyTextJson = LocationPagedResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LocationPagedResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        **kwargs,
        ...
        if validate:
            return LocationPagedResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LocationPagedResponsePydantic, raw_response.body)
