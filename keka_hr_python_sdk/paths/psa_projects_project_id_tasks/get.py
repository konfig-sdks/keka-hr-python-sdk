...
from keka_hr_python_sdk.model.api_project_task_paged_response import APIProjectTaskPagedResponse as APIProjectTaskPagedResponseSchema

from keka_hr_python_sdk.type.api_project_task_paged_response import APIProjectTaskPagedResponse

from ...api_client import Dictionary
from keka_hr_python_sdk.pydantic.api_project_task_paged_response import APIProjectTaskPagedResponse as APIProjectTaskPagedResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = APIProjectTaskPagedResponseSchema
SchemaFor200ResponseBodyTextJson = APIProjectTaskPagedResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: APIProjectTaskPagedResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> APIProjectTaskPagedResponsePydantic:
        ...
        if validate:
            return APIProjectTaskPagedResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(APIProjectTaskPagedResponsePydantic, raw_response.body)
