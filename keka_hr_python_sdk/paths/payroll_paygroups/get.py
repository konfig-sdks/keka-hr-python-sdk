...
from keka_hr_python_sdk.model.api_pay_group_view_paged_response import APIPayGroupViewPagedResponse as APIPayGroupViewPagedResponseSchema

from keka_hr_python_sdk.type.api_pay_group_view_paged_response import APIPayGroupViewPagedResponse

from ...api_client import Dictionary
from keka_hr_python_sdk.pydantic.api_pay_group_view_paged_response import APIPayGroupViewPagedResponse as APIPayGroupViewPagedResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = APIPayGroupViewPagedResponseSchema
SchemaFor200ResponseBodyTextJson = APIPayGroupViewPagedResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: APIPayGroupViewPagedResponse
    ...
    async def _aget_all_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/payroll/paygroups',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> APIPayGroupViewPagedResponsePydantic:
        ...
        if validate:
            return APIPayGroupViewPagedResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(APIPayGroupViewPagedResponsePydantic, raw_response.body)
