...
from keka_hr_python_sdk.model.api_department_view_paged_response import APIDepartmentViewPagedResponse as APIDepartmentViewPagedResponseSchema

from keka_hr_python_sdk.type.api_department_view_paged_response import APIDepartmentViewPagedResponse

from ...api_client import Dictionary
from keka_hr_python_sdk.pydantic.api_department_view_paged_response import APIDepartmentViewPagedResponse as APIDepartmentViewPagedResponsePydantic

from . import path

# Query params
DepartmentIdsSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'departmentIds': typing.Union[DepartmentIdsSchema, str, ],
...
SchemaFor200ResponseBodyApplicationJson = APIDepartmentViewPagedResponseSchema
SchemaFor200ResponseBodyTextJson = APIDepartmentViewPagedResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: APIDepartmentViewPagedResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_all_mapped_args(
        self,
        department_ids: typing.Optional[str] = None,
    ...
    async def _aget_all_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/hris/departments',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> APIDepartmentViewPagedResponsePydantic:
        ...
        if validate:
            return APIDepartmentViewPagedResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(APIDepartmentViewPagedResponsePydantic, raw_response.body)
