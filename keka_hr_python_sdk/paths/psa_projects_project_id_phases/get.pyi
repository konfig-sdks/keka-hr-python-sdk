...
from keka_hr_python_sdk.model.project_phase_paged_response import ProjectPhasePagedResponse as ProjectPhasePagedResponseSchema

from keka_hr_python_sdk.type.project_phase_paged_response import ProjectPhasePagedResponse

from ...api_client import Dictionary
from keka_hr_python_sdk.pydantic.project_phase_paged_response import ProjectPhasePagedResponse as ProjectPhasePagedResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ProjectPhasePagedResponseSchema
SchemaFor200ResponseBodyTextJson = ProjectPhasePagedResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ProjectPhasePagedResponse
    ...
    async def _aget_all_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/psa/projects/{projectId}/phases',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProjectPhasePagedResponsePydantic:
        ...
        if validate:
            return ProjectPhasePagedResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectPhasePagedResponsePydantic, raw_response.body)
