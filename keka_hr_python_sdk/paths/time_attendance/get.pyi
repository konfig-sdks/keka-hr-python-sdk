...
from keka_hr_python_sdk.model.attendance_summary_paged_response import AttendanceSummaryPagedResponse as AttendanceSummaryPagedResponseSchema

from keka_hr_python_sdk.type.attendance_summary_paged_response import AttendanceSummaryPagedResponse

from ...api_client import Dictionary
from keka_hr_python_sdk.pydantic.attendance_summary_paged_response import AttendanceSummaryPagedResponse as AttendanceSummaryPagedResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AttendanceSummaryPagedResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AttendanceSummaryPagedResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_records_in_range_mapped_args(
        self,
    ...
    async def _aget_records_in_range_oapg(
        self,
    ...
    def _get_records_in_range_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetRecordsInRangeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_records_in_range(
        self,
        employee_ids: typing.Optional[str] = None,
        _from: typing.Optional[datetime] = None,
        to: typing.Optional[datetime] = None,
        ...
        **kwargs,
        ...
        args = self._get_records_in_range_mapped_args(
        ...
        return await self._aget_records_in_range_oapg(
    ...
    def get_records_in_range(
        ...
        return self._get_records_in_range_oapg(
            query_params=args.query,
        )

class GetRecordsInRange(BaseApi):
    ...
    async def aget_records_in_range(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AttendanceSummaryPagedResponsePydantic:
        raw_response = await self.raw.aget_records_in_range(
            employee_ids=employee_ids,
            _from=_from,
            to=to,
            page_number=page_number,
        ...
        if validate:
            return AttendanceSummaryPagedResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AttendanceSummaryPagedResponsePydantic, raw_response.body)
    ...
    def get_records_in_range(
        ...
        raw_response = self.raw.get_records_in_range(
            employee_ids=employee_ids,
            _from=_from,
            to=to,
            page_number=page_number,
