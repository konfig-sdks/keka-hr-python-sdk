...
# Query params
AssetTypeIdsSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'assetTypeIds': typing.Union[AssetTypeIdsSchema, str, ],
...
request_query_asset_type_ids = api_client.QueryParameter(
    name="assetTypeIds",
    style=api_client.ParameterStyle.FORM,
    schema=AssetTypeIdsSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _get_all_mapped_args(
        self,
        asset_type_ids: typing.Optional[str] = None,
        ...
        if asset_type_ids is not None:
            _query_params["assetTypeIds"] = asset_type_ids
