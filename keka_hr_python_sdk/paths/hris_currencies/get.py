...
from keka_hr_python_sdk.model.currency_paged_response import CurrencyPagedResponse as CurrencyPagedResponseSchema

from keka_hr_python_sdk.type.currency_paged_response import CurrencyPagedResponse

from ...api_client import Dictionary
from keka_hr_python_sdk.pydantic.currency_paged_response import CurrencyPagedResponse as CurrencyPagedResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = CurrencyPagedResponseSchema
SchemaFor200ResponseBodyTextJson = CurrencyPagedResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CurrencyPagedResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        **kwargs,
        ...
        if validate:
            return CurrencyPagedResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CurrencyPagedResponsePydantic, raw_response.body)
