...
from keka_hr_python_sdk.model.update_project import UpdateProject as UpdateProjectSchema
...
from keka_hr_python_sdk.type.update_project import UpdateProject

from ...api_client import Dictionary
from keka_hr_python_sdk.pydantic.project_status import ProjectStatus as ProjectStatusPydantic
from keka_hr_python_sdk.pydantic.update_project import UpdateProject as UpdateProjectPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdateProjectSchema
SchemaForRequestBodyTextJson = UpdateProjectSchema
SchemaForRequestBodyApplicationJsonPatchjson = UpdateProjectSchema
SchemaForRequestBodyApplicationJson = UpdateProjectSchema


request_body_update_project = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_details_mapped_args(
        ...
        is_billable: typing.Optional[typing.Optional[bool]] = None,
    ...
    async def _aupdate_details_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/psa/projects/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_update_project.serialize(body, content_type)
