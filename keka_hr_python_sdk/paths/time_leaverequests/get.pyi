...
from keka_hr_python_sdk.model.leave_request_paged_response import LeaveRequestPagedResponse as LeaveRequestPagedResponseSchema

from keka_hr_python_sdk.type.leave_request_paged_response import LeaveRequestPagedResponse

from ...api_client import Dictionary
from keka_hr_python_sdk.pydantic.leave_request_paged_response import LeaveRequestPagedResponse as LeaveRequestPagedResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = LeaveRequestPagedResponseSchema
SchemaFor200ResponseBodyTextJson = LeaveRequestPagedResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LeaveRequestPagedResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_all_between_dates_mapped_args(
        self,
    ...
    async def _aget_all_between_dates_oapg(
        self,
    ...
    def _get_all_between_dates_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetAllBetweenDatesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_between_dates(
        self,
        employee_ids: typing.Optional[str] = None,
        _from: typing.Optional[datetime] = None,
        to: typing.Optional[datetime] = None,
        ...
        **kwargs,
        ...
        args = self._get_all_between_dates_mapped_args(
        ...
        return await self._aget_all_between_dates_oapg(
    ...
    def get_all_between_dates(
        ...
        return self._get_all_between_dates_oapg(
            query_params=args.query,
        )

class GetAllBetweenDates(BaseApi):
    ...
    async def aget_all_between_dates(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LeaveRequestPagedResponsePydantic:
        raw_response = await self.raw.aget_all_between_dates(
            employee_ids=employee_ids,
            _from=_from,
            to=to,
            page_number=page_number,
        ...
        if validate:
            return LeaveRequestPagedResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LeaveRequestPagedResponsePydantic, raw_response.body)
    ...
    def get_all_between_dates(
        ...
        raw_response = self.raw.get_all_between_dates(
            employee_ids=employee_ids,
            _from=_from,
            to=to,
            page_number=page_number,
