...
from keka_hr_python_sdk.model.api_client_paged_response import APIClientPagedResponse as APIClientPagedResponseSchema

from keka_hr_python_sdk.type.api_client_paged_response import APIClientPagedResponse

from ...api_client import Dictionary
from keka_hr_python_sdk.pydantic.api_client_paged_response import APIClientPagedResponse as APIClientPagedResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = APIClientPagedResponseSchema
SchemaFor200ResponseBodyTextJson = APIClientPagedResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: APIClientPagedResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> APIClientPagedResponsePydantic:
        ...
        if validate:
            return APIClientPagedResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(APIClientPagedResponsePydantic, raw_response.body)
