...
from keka_hr_python_sdk.model.asset_paged_response import AssetPagedResponse as AssetPagedResponseSchema

from keka_hr_python_sdk.type.asset_paged_response import AssetPagedResponse

from ...api_client import Dictionary
from keka_hr_python_sdk.pydantic.asset_paged_response import AssetPagedResponse as AssetPagedResponsePydantic

from . import path

# Query params
AssetIdsSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'assetIds': typing.Union[AssetIdsSchema, str, ],
...
request_query_asset_ids = api_client.QueryParameter(
    name="assetIds",
...
request_query_asset_status = api_client.QueryParameter(
    name="assetStatus",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = AssetPagedResponseSchema
SchemaFor200ResponseBodyTextJson = AssetPagedResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AssetPagedResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_all_mapped_args(
        ...
        asset_status: typing.Optional[str] = None,
        ...
        if asset_ids is not None:
            _query_params["assetIds"] = asset_ids
        if employee_ids is not None:
            _query_params["employeeIds"] = employee_ids
        if asset_status is not None:
            _query_params["assetStatus"] = asset_status
    ...
    async def _aget_all_oapg(
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_asset_ids,
            request_query_employee_ids,
            request_query_asset_status,
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        **kwargs,
        ...
        if validate:
            return AssetPagedResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AssetPagedResponsePydantic, raw_response.body)
