...
from keka_hr_python_sdk.model.update_project_task import UpdateProjectTask as UpdateProjectTaskSchema
from keka_hr_python_sdk.model.update_project_task_assigned_to import UpdateProjectTaskAssignedTo as UpdateProjectTaskAssignedToSchema
from keka_hr_python_sdk.model.boolean_response import BooleanResponse as BooleanResponseSchema

from keka_hr_python_sdk.type.update_project_task import UpdateProjectTask
...
from keka_hr_python_sdk.pydantic.update_project_task import UpdateProjectTask as UpdateProjectTaskPydantic
from keka_hr_python_sdk.pydantic.update_project_task_assigned_to import UpdateProjectTaskAssignedTo as UpdateProjectTaskAssignedToPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdateProjectTaskSchema
SchemaForRequestBodyTextJson = UpdateProjectTaskSchema
SchemaForRequestBodyApplicationJsonPatchjson = UpdateProjectTaskSchema
SchemaForRequestBodyApplicationJson = UpdateProjectTaskSchema


request_body_update_project_task = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_task_mapped_args(
        ...
        assigned_to: typing.Optional[UpdateProjectTaskAssignedTo] = None,
    ...
    async def _aupdate_task_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/psa/projects/{projectId}/tasks/{taskId}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_update_project_task.serialize(body, content_type)
...
class UpdateTaskRaw(BaseApi):
    ...
    async def aupdate_task(
        ...
        **kwargs,
        ...
        args = self._update_task_mapped_args(
        ...
        return await self._aupdate_task_oapg(
            body=args.body,
    ...
    def update_task(
        ...
        return self._update_task_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateTask(BaseApi):
    ...
    async def aupdate_task(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_task(
            project_id=project_id,
            task_id=task_id,
            description=description,
            name=name,
    ...
    def update_task(
        ...
        raw_response = self.raw.update_task(
            project_id=project_id,
            task_id=task_id,
            description=description,
            name=name,
