...
from keka_hr_python_sdk.model.requisition_request_paged_response import RequisitionRequestPagedResponse as RequisitionRequestPagedResponseSchema

from keka_hr_python_sdk.type.requisition_request_paged_response import RequisitionRequestPagedResponse

from ...api_client import Dictionary
from keka_hr_python_sdk.pydantic.requisition_request_paged_response import RequisitionRequestPagedResponse as RequisitionRequestPagedResponsePydantic

# Query params
RequisitionRequestIdsSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'requisitionRequestIds': typing.Union[RequisitionRequestIdsSchema, str, ],
...
request_query_requisition_request_ids = api_client.QueryParameter(
    name="requisitionRequestIds",
    style=api_client.ParameterStyle.FORM,
    schema=RequisitionRequestIdsSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = RequisitionRequestPagedResponseSchema
SchemaFor200ResponseBodyTextJson = RequisitionRequestPagedResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: RequisitionRequestPagedResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_all_mapped_args(
        self,
        requisition_request_ids: typing.Optional[str] = None,
        ...
        _query_params = {}
        if requisition_request_ids is not None:
            _query_params["requisitionRequestIds"] = requisition_request_ids
    ...
    async def _aget_all_oapg(
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_requisition_request_ids,
        ...
        request_before_hook(
            ...
            path_template='/requisition/requests',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    async def aget_all(
        ...
        **kwargs,
        ...
        args = self._get_all_mapped_args(
            requisition_request_ids=requisition_request_ids,
            status=status,
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> RequisitionRequestPagedResponsePydantic:
        ...
        if validate:
            return RequisitionRequestPagedResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(RequisitionRequestPagedResponsePydantic, raw_response.body)
