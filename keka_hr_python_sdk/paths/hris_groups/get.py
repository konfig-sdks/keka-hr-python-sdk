...
from keka_hr_python_sdk.model.group_paged_response import GroupPagedResponse as GroupPagedResponseSchema

from keka_hr_python_sdk.type.group_paged_response import GroupPagedResponse

from ...api_client import Dictionary
from keka_hr_python_sdk.pydantic.group_paged_response import GroupPagedResponse as GroupPagedResponsePydantic

from . import path

# Query params
GroupTypeIdsSchema = schemas.StrSchema
SystemGroupTypesSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'groupTypeIds': typing.Union[GroupTypeIdsSchema, str, ],
        'systemGroupTypes': typing.Union[SystemGroupTypesSchema, str, ],
...
request_query_group_type_ids = api_client.QueryParameter(
    name="groupTypeIds",
    style=api_client.ParameterStyle.FORM,
    schema=GroupTypeIdsSchema,
    explode=True,
)
request_query_system_group_types = api_client.QueryParameter(
    name="systemGroupTypes",
    style=api_client.ParameterStyle.FORM,
    schema=SystemGroupTypesSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = GroupPagedResponseSchema
SchemaFor200ResponseBodyTextJson = GroupPagedResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GroupPagedResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_all_mapped_args(
        self,
        group_type_ids: typing.Optional[str] = None,
        system_group_types: typing.Optional[str] = None,
        ...
        if group_type_ids is not None:
            _query_params["groupTypeIds"] = group_type_ids
        if system_group_types is not None:
            _query_params["systemGroupTypes"] = system_group_types
    ...
    async def _aget_all_oapg(
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_group_type_ids,
            request_query_system_group_types,
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        **kwargs,
        ...
        if validate:
            return GroupPagedResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GroupPagedResponsePydantic, raw_response.body)
