...
from keka_hr_python_sdk.model.job_title_paged_response import JobTitlePagedResponse as JobTitlePagedResponseSchema

from keka_hr_python_sdk.type.job_title_paged_response import JobTitlePagedResponse

from ...api_client import Dictionary
from keka_hr_python_sdk.pydantic.job_title_paged_response import JobTitlePagedResponse as JobTitlePagedResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = JobTitlePagedResponseSchema
SchemaFor200ResponseBodyTextJson = JobTitlePagedResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: JobTitlePagedResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        **kwargs,
        ...
        if validate:
            return JobTitlePagedResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(JobTitlePagedResponsePydantic, raw_response.body)
