...
from keka_hr_python_sdk.pydantic.boolean_response_errors import BooleanResponseErrors
...
class BooleanResponse(BaseModel):
    ...
    errors: typing.Optional[BooleanResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[bool] = Field(None, alias='data')
