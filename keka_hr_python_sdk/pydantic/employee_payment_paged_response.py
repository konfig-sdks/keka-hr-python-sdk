...
from keka_hr_python_sdk.pydantic.employee_payment import EmployeePayment
from keka_hr_python_sdk.pydantic.employee_payment_paged_response_errors import EmployeePaymentPagedResponseErrors

class EmployeePaymentPagedResponse(BaseModel):
    ...
    errors: typing.Optional[EmployeePaymentPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[EmployeePayment]]] = Field(None, alias='data')
