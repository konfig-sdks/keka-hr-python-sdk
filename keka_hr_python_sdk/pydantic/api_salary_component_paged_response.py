...
from keka_hr_python_sdk.pydantic.api_salary_component import APISalaryComponent
from keka_hr_python_sdk.pydantic.api_salary_component_paged_response_errors import APISalaryComponentPagedResponseErrors

class APISalaryComponentPagedResponse(BaseModel):
    ...
    errors: typing.Optional[APISalaryComponentPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[APISalaryComponent]]] = Field(None, alias='data')
