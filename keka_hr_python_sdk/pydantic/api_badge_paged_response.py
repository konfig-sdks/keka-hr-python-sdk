...
from keka_hr_python_sdk.pydantic.api_badge import APIBadge
from keka_hr_python_sdk.pydantic.api_badge_paged_response_errors import APIBadgePagedResponseErrors

class APIBadgePagedResponse(BaseModel):
    ...
    errors: typing.Optional[APIBadgePagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[APIBadge]]] = Field(None, alias='data')
