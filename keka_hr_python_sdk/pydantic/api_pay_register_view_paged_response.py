...
from keka_hr_python_sdk.pydantic.api_pay_register_view import APIPayRegisterView
from keka_hr_python_sdk.pydantic.api_pay_register_view_paged_response_errors import APIPayRegisterViewPagedResponseErrors

class APIPayRegisterViewPagedResponse(BaseModel):
    ...
    errors: typing.Optional[APIPayRegisterViewPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[APIPayRegisterView]]] = Field(None, alias='data')
