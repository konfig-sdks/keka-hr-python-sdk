...
from keka_hr_python_sdk.pydantic.api_department_view import APIDepartmentView
from keka_hr_python_sdk.pydantic.api_department_view_paged_response_errors import APIDepartmentViewPagedResponseErrors

class APIDepartmentViewPagedResponse(BaseModel):
    ...
    errors: typing.Optional[APIDepartmentViewPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[APIDepartmentView]]] = Field(None, alias='data')
