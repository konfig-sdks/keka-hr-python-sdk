...
class PaymentTransaction(BaseModel):
    payment_identifier: typing.Optional[typing.Optional[str]] = Field(None, alias='paymentIdentifier')

    status: typing.Optional[PaymentStatus] = Field(None, alias='status')

    transaction_on: typing.Optional[datetime] = Field(None, alias='transactionOn')
