...
from keka_hr_python_sdk.pydantic.api_goal import APIGoal
from keka_hr_python_sdk.pydantic.api_goal_paged_response_errors import APIGoalPagedResponseErrors

class APIGoalPagedResponse(BaseModel):
    ...
    errors: typing.Optional[APIGoalPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[APIGoal]]] = Field(None, alias='data')
