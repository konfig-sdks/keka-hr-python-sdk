...
from keka_hr_python_sdk.pydantic.api_review_group import APIReviewGroup
from keka_hr_python_sdk.pydantic.api_review_group_paged_response_errors import APIReviewGroupPagedResponseErrors

class APIReviewGroupPagedResponse(BaseModel):
    ...
    errors: typing.Optional[APIReviewGroupPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[APIReviewGroup]]] = Field(None, alias='data')
