...
from keka_hr_python_sdk.pydantic.api_project_paged_response_errors import APIProjectPagedResponseErrors

class APIProjectPagedResponse(BaseModel):
    ...
    errors: typing.Optional[APIProjectPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[APIProject]]] = Field(None, alias='data')
