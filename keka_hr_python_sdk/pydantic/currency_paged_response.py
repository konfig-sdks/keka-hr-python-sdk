...
from keka_hr_python_sdk.pydantic.currency import Currency
from keka_hr_python_sdk.pydantic.currency_paged_response_errors import CurrencyPagedResponseErrors

class CurrencyPagedResponse(BaseModel):
    ...
    errors: typing.Optional[CurrencyPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[Currency]]] = Field(None, alias='data')
