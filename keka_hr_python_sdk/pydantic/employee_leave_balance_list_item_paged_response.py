...
from keka_hr_python_sdk.pydantic.employee_leave_balance_list_item import EmployeeLeaveBalanceListItem
from keka_hr_python_sdk.pydantic.employee_leave_balance_list_item_paged_response_errors import EmployeeLeaveBalanceListItemPagedResponseErrors

class EmployeeLeaveBalanceListItemPagedResponse(BaseModel):
    ...
    errors: typing.Optional[EmployeeLeaveBalanceListItemPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[EmployeeLeaveBalanceListItem]]] = Field(None, alias='data')
