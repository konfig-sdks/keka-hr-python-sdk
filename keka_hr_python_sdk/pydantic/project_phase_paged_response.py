...
from keka_hr_python_sdk.pydantic.project_phase import ProjectPhase
from keka_hr_python_sdk.pydantic.project_phase_paged_response_errors import ProjectPhasePagedResponseErrors

class ProjectPhasePagedResponse(BaseModel):
    ...
    errors: typing.Optional[ProjectPhasePagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[ProjectPhase]]] = Field(None, alias='data')
