...
from keka_hr_python_sdk.pydantic.api_project_task import APIProjectTask
from keka_hr_python_sdk.pydantic.api_project_task_paged_response_errors import APIProjectTaskPagedResponseErrors

class APIProjectTaskPagedResponse(BaseModel):
    ...
    errors: typing.Optional[APIProjectTaskPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[APIProjectTask]]] = Field(None, alias='data')
