...
class Experience(BaseModel):
    ...
    date_of_joining: typing.Optional[typing.Optional[datetime]] = Field(None, alias='dateOfJoining')

    date_of_relieving: typing.Optional[typing.Optional[datetime]] = Field(None, alias='dateOfRelieving')
