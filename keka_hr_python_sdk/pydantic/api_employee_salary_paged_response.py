...
from keka_hr_python_sdk.pydantic.api_employee_salary import APIEmployeeSalary
from keka_hr_python_sdk.pydantic.api_employee_salary_paged_response_errors import APIEmployeeSalaryPagedResponseErrors

class APIEmployeeSalaryPagedResponse(BaseModel):
    ...
    errors: typing.Optional[APIEmployeeSalaryPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[APIEmployeeSalary]]] = Field(None, alias='data')
