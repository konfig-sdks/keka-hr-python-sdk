...
from keka_hr_python_sdk.pydantic.employee_profile import EmployeeProfile
from keka_hr_python_sdk.pydantic.employee_profile_paged_response_errors import EmployeeProfilePagedResponseErrors

class EmployeeProfilePagedResponse(BaseModel):
    ...
    errors: typing.Optional[EmployeeProfilePagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[EmployeeProfile]]] = Field(None, alias='data')
