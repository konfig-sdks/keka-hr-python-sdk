...
from keka_hr_python_sdk.pydantic.string_response_errors import StringResponseErrors
...
class StringResponse(BaseModel):
    ...
    errors: typing.Optional[StringResponseErrors] = Field(None, alias='errors')
