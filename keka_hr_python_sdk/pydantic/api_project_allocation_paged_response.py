...
from keka_hr_python_sdk.pydantic.api_project_allocation import APIProjectAllocation
from keka_hr_python_sdk.pydantic.api_project_allocation_paged_response_errors import APIProjectAllocationPagedResponseErrors

class APIProjectAllocationPagedResponse(BaseModel):
    ...
    errors: typing.Optional[APIProjectAllocationPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[APIProjectAllocation]]] = Field(None, alias='data')
