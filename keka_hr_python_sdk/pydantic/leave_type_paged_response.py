...
from keka_hr_python_sdk.pydantic.leave_type import LeaveType
from keka_hr_python_sdk.pydantic.leave_type_paged_response_errors import LeaveTypePagedResponseErrors

class LeaveTypePagedResponse(BaseModel):
    ...
    errors: typing.Optional[LeaveTypePagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[LeaveType]]] = Field(None, alias='data')
