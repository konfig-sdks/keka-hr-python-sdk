...
from keka_hr_python_sdk.pydantic.leave_request import LeaveRequest
from keka_hr_python_sdk.pydantic.leave_request_paged_response_errors import LeaveRequestPagedResponseErrors

class LeaveRequestPagedResponse(BaseModel):
    ...
    errors: typing.Optional[LeaveRequestPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[LeaveRequest]]] = Field(None, alias='data')
