...
from keka_hr_python_sdk.pydantic.api_employee_review import APIEmployeeReview
from keka_hr_python_sdk.pydantic.api_employee_review_paged_response_errors import APIEmployeeReviewPagedResponseErrors

class APIEmployeeReviewPagedResponse(BaseModel):
    ...
    errors: typing.Optional[APIEmployeeReviewPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[APIEmployeeReview]]] = Field(None, alias='data')
