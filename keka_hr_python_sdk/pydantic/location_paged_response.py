...
from keka_hr_python_sdk.pydantic.location import Location
from keka_hr_python_sdk.pydantic.location_paged_response_errors import LocationPagedResponseErrors

class LocationPagedResponse(BaseModel):
    ...
    errors: typing.Optional[LocationPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[Location]]] = Field(None, alias='data')
