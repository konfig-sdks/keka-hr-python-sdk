...
from keka_hr_python_sdk.pydantic.group_type import GroupType
from keka_hr_python_sdk.pydantic.group_type_paged_response_errors import GroupTypePagedResponseErrors

class GroupTypePagedResponse(BaseModel):
    ...
    errors: typing.Optional[GroupTypePagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[GroupType]]] = Field(None, alias='data')
