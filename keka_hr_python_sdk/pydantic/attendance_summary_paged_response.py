...
from keka_hr_python_sdk.pydantic.attendance_summary import AttendanceSummary
from keka_hr_python_sdk.pydantic.attendance_summary_paged_response_errors import AttendanceSummaryPagedResponseErrors

class AttendanceSummaryPagedResponse(BaseModel):
    ...
    errors: typing.Optional[AttendanceSummaryPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[AttendanceSummary]]] = Field(None, alias='data')
