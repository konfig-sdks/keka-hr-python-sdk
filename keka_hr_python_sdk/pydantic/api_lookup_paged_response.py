...
from keka_hr_python_sdk.pydantic.api_lookup_paged_response_errors import ApiLookupPagedResponseErrors

class ApiLookupPagedResponse(BaseModel):
    ...
    errors: typing.Optional[ApiLookupPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[ApiLookup]]] = Field(None, alias='data')
