...
from keka_hr_python_sdk.pydantic.api_review_cycle import APIReviewCycle
from keka_hr_python_sdk.pydantic.api_review_cycle_paged_response_errors import APIReviewCyclePagedResponseErrors

class APIReviewCyclePagedResponse(BaseModel):
    ...
    errors: typing.Optional[APIReviewCyclePagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[APIReviewCycle]]] = Field(None, alias='data')
