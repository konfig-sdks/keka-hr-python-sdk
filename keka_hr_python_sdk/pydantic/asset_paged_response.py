...
from keka_hr_python_sdk.pydantic.asset import Asset
from keka_hr_python_sdk.pydantic.asset_paged_response_errors import AssetPagedResponseErrors

class AssetPagedResponse(BaseModel):
    ...
    errors: typing.Optional[AssetPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[Asset]]] = Field(None, alias='data')
