...
from keka_hr_python_sdk.pydantic.api_client_contact import APIClientContact
from keka_hr_python_sdk.pydantic.psa_custom_field import PSACustomField
...
class APIClient(BaseModel):
    ...
    client_contacts: typing.Optional[typing.Optional[typing.List[APIClientContact]]] = Field(None, alias='clientContacts')

    additional_fields: typing.Optional[typing.Optional[typing.List[PSACustomField]]] = Field(None, alias='additionalFields')
