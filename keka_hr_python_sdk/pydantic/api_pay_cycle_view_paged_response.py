...
from keka_hr_python_sdk.pydantic.api_pay_cycle_view import APIPayCycleView
from keka_hr_python_sdk.pydantic.api_pay_cycle_view_paged_response_errors import APIPayCycleViewPagedResponseErrors

class APIPayCycleViewPagedResponse(BaseModel):
    ...
    errors: typing.Optional[APIPayCycleViewPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[APIPayCycleView]]] = Field(None, alias='data')
