...
from keka_hr_python_sdk.pydantic.group import Group
from keka_hr_python_sdk.pydantic.group_paged_response_errors import GroupPagedResponseErrors

class GroupPagedResponse(BaseModel):
    ...
    errors: typing.Optional[GroupPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[Group]]] = Field(None, alias='data')
