...
from keka_hr_python_sdk.pydantic.api_timesheet_entry import APITimesheetEntry
from keka_hr_python_sdk.pydantic.api_timesheet_entry_paged_response_errors import APITimesheetEntryPagedResponseErrors

class APITimesheetEntryPagedResponse(BaseModel):
    ...
    errors: typing.Optional[APITimesheetEntryPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[APITimesheetEntry]]] = Field(None, alias='data')
