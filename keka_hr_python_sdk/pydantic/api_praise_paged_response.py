...
from keka_hr_python_sdk.pydantic.api_praise import APIPraise
from keka_hr_python_sdk.pydantic.api_praise_paged_response_errors import APIPraisePagedResponseErrors

class APIPraisePagedResponse(BaseModel):
    ...
    errors: typing.Optional[APIPraisePagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[APIPraise]]] = Field(None, alias='data')
