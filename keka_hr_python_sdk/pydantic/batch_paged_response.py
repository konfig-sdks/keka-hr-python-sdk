...
from keka_hr_python_sdk.pydantic.batch import Batch
from keka_hr_python_sdk.pydantic.batch_paged_response_errors import BatchPagedResponseErrors

class BatchPagedResponse(BaseModel):
    ...
    errors: typing.Optional[BatchPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[Batch]]] = Field(None, alias='data')
