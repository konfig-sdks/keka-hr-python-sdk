...
from keka_hr_python_sdk.pydantic.expense_claim import ExpenseClaim
from keka_hr_python_sdk.pydantic.expense_claim_paged_response_errors import ExpenseClaimPagedResponseErrors

class ExpenseClaimPagedResponse(BaseModel):
    ...
    errors: typing.Optional[ExpenseClaimPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[ExpenseClaim]]] = Field(None, alias='data')
