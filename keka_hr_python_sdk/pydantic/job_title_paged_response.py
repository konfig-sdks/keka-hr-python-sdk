...
from keka_hr_python_sdk.pydantic.job_title import JobTitle
from keka_hr_python_sdk.pydantic.job_title_paged_response_errors import JobTitlePagedResponseErrors

class JobTitlePagedResponse(BaseModel):
    ...
    errors: typing.Optional[JobTitlePagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[JobTitle]]] = Field(None, alias='data')
