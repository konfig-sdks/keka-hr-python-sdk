...
from keka_hr_python_sdk.pydantic.api_client import APIClient
from keka_hr_python_sdk.pydantic.api_client_paged_response_errors import APIClientPagedResponseErrors

class APIClientPagedResponse(BaseModel):
    ...
    errors: typing.Optional[APIClientPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[APIClient]]] = Field(None, alias='data')
