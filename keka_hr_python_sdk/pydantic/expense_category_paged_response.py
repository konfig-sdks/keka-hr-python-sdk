...
from keka_hr_python_sdk.pydantic.expense_category import ExpenseCategory
from keka_hr_python_sdk.pydantic.expense_category_paged_response_errors import ExpenseCategoryPagedResponseErrors

class ExpenseCategoryPagedResponse(BaseModel):
    ...
    errors: typing.Optional[ExpenseCategoryPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[ExpenseCategory]]] = Field(None, alias='data')
