...
from keka_hr_python_sdk.pydantic.api_pay_group_view import APIPayGroupView
from keka_hr_python_sdk.pydantic.api_pay_group_view_paged_response_errors import APIPayGroupViewPagedResponseErrors

class APIPayGroupViewPagedResponse(BaseModel):
    ...
    errors: typing.Optional[APIPayGroupViewPagedResponseErrors] = Field(None, alias='errors')

    # Gets or sets the data.
    data: typing.Optional[typing.Optional[typing.List[APIPayGroupView]]] = Field(None, alias='data')
