...
class RequiredExperienceDTO(TypedDict):
    pass

class OptionalExperienceDTO(TypedDict, total=False):
    # Gets or sets the company name.
    companyName: typing.Optional[str]

    # Gets or sets the designation.
    designation: typing.Optional[str]
    ...
    dateOfRelieving: typing.Optional[str]

    # Gets or sets the location.
    location: typing.Optional[str]

class ExperienceDTO(RequiredExperienceDTO, OptionalExperienceDTO):
    pass
