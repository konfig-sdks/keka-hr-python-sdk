...
from keka_hr_python_sdk.type.expense import Expense
from keka_hr_python_sdk.type.expense_claim_approval_status import ExpenseClaimApprovalStatus
...
class OptionalExpenseClaim(TypedDict, total=False):
    ...
    claimNumber: typing.Optional[str]

    submittedOn: datetime

    approvalStatus: ExpenseClaimApprovalStatus

    expenses: typing.Optional[typing.List[Expense]]
