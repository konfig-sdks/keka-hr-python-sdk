...
from keka_hr_python_sdk.type.leave_request_status import LeaveRequestStatus
from keka_hr_python_sdk.type.leave_type_selection import LeaveTypeSelection
...
class OptionalLeaveRequest(TypedDict, total=False):
    ...
    selection: typing.Optional[typing.List[LeaveTypeSelection]]

    cancelRejectReason: typing.Optional[str]
