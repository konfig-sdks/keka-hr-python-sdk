...
class EmployeePayment(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["forPeriod"]) -> MetaOapg.properties.forPeriod: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["amount"]) -> MetaOapg.properties.amount: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["salaryPaymentMode"]) -> MetaOapg.properties.salaryPaymentMode: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["bankName"]) -> MetaOapg.properties.bankName: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ifscCode"]) -> MetaOapg.properties.ifscCode: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "employeeNumber", "employeeName", "forPeriod", "amount", "salaryPaymentMode", "bankName", "ifscCode", "accountNumber", "status", "identifier", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["forPeriod"]) -> typing.Union[MetaOapg.properties.forPeriod, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["amount"]) -> typing.Union[MetaOapg.properties.amount, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["salaryPaymentMode"]) -> typing.Union[MetaOapg.properties.salaryPaymentMode, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["bankName"]) -> typing.Union[MetaOapg.properties.bankName, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ifscCode"]) -> typing.Union[MetaOapg.properties.ifscCode, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "employeeNumber", "employeeName", "forPeriod", "amount", "salaryPaymentMode", "bankName", "ifscCode", "accountNumber", "status", "identifier", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        forPeriod: typing.Union[MetaOapg.properties.forPeriod, None, str, schemas.Unset] = schemas.unset,
        amount: typing.Union[MetaOapg.properties.amount, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        salaryPaymentMode: typing.Union[MetaOapg.properties.salaryPaymentMode, None, str, schemas.Unset] = schemas.unset,
        bankName: typing.Union[MetaOapg.properties.bankName, None, str, schemas.Unset] = schemas.unset,
        ifscCode: typing.Union[MetaOapg.properties.ifscCode, None, str, schemas.Unset] = schemas.unset,
