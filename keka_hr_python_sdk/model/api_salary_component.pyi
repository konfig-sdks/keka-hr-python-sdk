...
class APISalaryComponent(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "id", "identifier", "accountingCode", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "id", "identifier", "accountingCode", ], str]):
