...
class JobCustomFieldDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["fieldName", "required", "fieldType", "value", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["fieldName", "required", "fieldType", "value", ], str]):
