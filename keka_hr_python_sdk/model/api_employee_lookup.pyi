...
class APIEmployeeLookup(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "employeeNumber", "employeeName", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "employeeNumber", "employeeName", ], str]):
